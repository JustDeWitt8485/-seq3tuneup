...
dup_list = ["1990\tJacob's Ladder", '1990\tThe Two Jakes',
            '1991\tHouse Party 2',
            '1992\tThe Distinguished Gentleman',
            '1994\tBlown Away', '1995\tMoney Train',
            '1999\tAmerican Pie', '2010\tEat Pray Love', '2014\tBig Hero 6']
...
class TestTuneup(unittest.TestCase):
    ...
    def test_optimized_find_duplicate_movies(self):
        ...
        opt_result = sorted(self.module.optimized_find_duplicate_movies
                            ("movies.txt"))
        self.assertIsInstance(
            opt_result, list,
    ...
    def test_improvement_factor(self):
        ...
        orig_time = function_timer(self.module.find_duplicate_movies,
                                   "movies.txt")
